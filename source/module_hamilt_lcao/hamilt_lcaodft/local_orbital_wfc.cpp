    ...
    const int& istep)
{
	...
	if(this->wfck_flag == false)
	{
		...
		this->wfck_flag = true;
         // HEREADD4 
        ModuleBase::Memory::record("****LOWF::wfc_k_grid", sizeof(std::complex<double>) * nks*GlobalV::NBANDS);
	...
	if(lgd != 0)
	{
        ...
        // HEREADD4 change
        ModuleBase::Memory::record("****LOWF::wfc_k_grid2", sizeof(std::complex<double>) * nks*page);
	}
