                                            ...
                                            const psi::Psi<complex<FPTYPE>, Device>* psi_in)
{
    ...
    // HEREADD2
	ModuleBase::Memory::record("*2_Stree_func::stress_nl",sizeof(double)*nkb*npwx*4 + sizeof(int)*GlobalC::ucell.ntype*2);
...
// HEREADD2
	ModuleBase::Memory::record("**2_Stree_func::get_dvnl1",sizeof(ModuleBase::Vector3<FPTYPE>)*npw + 
    sizeof(double)*(nhm*npw+x1*npw) + sizeof(FPTYPE)*npw );
                                            ...
                                            ModulePW::PW_Basis_K *wfc_basis)
{
    ...
    // HEREADD2
	ModuleBase::Memory::record("**2_Stree_func::get_dvnl2",sizeof(ModuleBase::Vector3<FPTYPE>)*npw + 
    sizeof(double)*(nhm*npw+x1*npw) + sizeof(FPTYPE)*npw );
